...
func newVolumes(c *EcsV1Client, namespace string) *volumes {
	return &volumes{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *volumes) Get(name string, options meta_v1.GetOptions) (result *v1.Volume, err error) {
	result = &v1.Volume{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("volumes").
...
func (c *volumes) List(opts meta_v1.ListOptions) (result *v1.VolumeList, err error) {
...
func (c *volumes) Watch(opts meta_v1.ListOptions) (watch.Interface, error) {
	opts.Watch = true
	return c.client.Get().
		Namespace(c.ns).
		Resource("volumes").
...
func (c *volumes) Delete(name string, options *meta_v1.DeleteOptions) error {
...
func (c *volumes) DeleteCollection(options *meta_v1.DeleteOptions, listOptions meta_v1.ListOptions) error {
	return c.client.Delete().
		Namespace(c.ns).
		Resource("volumes").
